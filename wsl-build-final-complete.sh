...
echo " 最终完整版 - 修复 ENUM 检查错误"
echo "========================================"

BUILD_DIR="/tmp/strongswan-gmsm-success"
...
echo ""
echo "步骤 5: 修改 public_key.c - 添加 SM2 签名名称..."
# 找到 ENUM 定义的结束位置,在 SIGN_BLISS_WITH_SHA3_512 之前添加 SIGN_SM2_WITH_SM3
# 首先修改枚举范围为包含 SIGN_SM2_WITH_SM3
sed -i 's/ENUM(signature_scheme_names, SIGN_UNKNOWN, SIGN_BLISS_WITH_SHA3_512,/ENUM(signature_scheme_names, SIGN_UNKNOWN, SIGN_SM2_WITH_SM3,/' src/libstrongswan/credentials/keys/public_key.c

# 在 "BLISS_WITH_SHA3_512" 之前添加 "SM2_WITH_SM3"
sed -i '/"BLISS_WITH_SHA3_512"/i\	"SM2_WITH_SM3",' src/libstrongswan/credentials/keys/public_key.c
